...
#                                                shape=[5,5,self._channel,16], dtype=tf.float32)
...
#                                                shape=[5,5,16,32], dtype=tf.float32)
...
#                                                shape=[5,5,32,64], dtype=tf.float32)
...
#                                                   shape=[3,3,32,64], dtype=tf.float32)
...
#                                                   shape=[3,3,16,32], dtype=tf.float32)
...
#                                                shape=[5, 5, 8, self._channel], dtype=tf.float32)
